...
exports.checkDay = exports.task = exports.multiplication = void 0;
/**
 ...
 */
const task = (w, n, c) => multiplication(n, c) > 0 ? `It is ${w} today, ${checkDay(w)}, you have to work, you must spray ${n} trees and you need ${multiplication(n, c)} dollars to buy liquid` : "Oh no, que don't expect a negative number, so please, check this out";
exports.task = task;
/**
 ...
 */
const multiplication = (n, c) => (n > 0 && c > 0) ? n * c : -1;
...
//# sourceMappingURL=sprayingTrees.js.map